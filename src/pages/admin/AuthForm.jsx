...
const AuthForm = ({isRegister}) => {
	...
	const {
		...
		handleSubmit,
		formState: { errors },
	} = useForm({ resolver: zodResolver(isRegister ?  registerSchema : loginSchema) });
		...
		<div>
			<form onSubmit={handleSubmit(onSubmit)}>
				...
				<div className="mb-3">
					...
					<input id="password" className="form-control" type="password" {...register("password")} />
				...
				{isRegister && (
					<div className="mb-3">
						...
						<input id="confirmPass" className="form-control" type="password" {...register("confirmPass")} />
